(function(user, item, itemViewModel, headerViewModel){
    ...
    var items = [
        ...
        new item("Bil", 2, 200000, new Date("5.1.2013"), descriptions[1]),
        new item("Xbox", 3, 1500, new Date("5.1.2013"), descriptions[2]),
        new item("TV", 4, 12000, new Date("5.1.2013"), descriptions[3]),
        new item("Lommebok", 5, 150, new Date("5.1.2013"), descriptions[0])
    ];
